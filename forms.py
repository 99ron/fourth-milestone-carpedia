...
from wtforms import StringField, PasswordField, BooleanField, SubmitField, SelectField, FloatField, IntegerField, validators
...
class CarToDatabase(FlaskForm):
    ...
    car_img = StringField('Enter a link to an image', validators=['.jpg', '.png'])
    trans = SelectField('Transmission Type', choices=[('Manual', 'Manual'), ('SemiA', 'Semi-Auto'), ('Auto', 'Automatic'), ('Sequential', 'Sequential')], validators=[DataRequired])
    ...
    car_desc = StringField('Enter a description', validators=[DataRequired])
    ...
    accel = FloatField('0-60 Time (Seconds)', validators=[DataRequired])
